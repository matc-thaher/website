...
<section id="galaxy-formation" class="research-section flip">
    ...
    <video controls preload="metadata" poster="{{ '/assets/Images/FDM_halo.png' | relative_url }}" 
        style="margin-top:12px; width:100%; max-width:100%; display:block; aspect-ratio:5/4;">
